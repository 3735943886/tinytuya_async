...
from tinytuya.core.const import DEVICEFILE, TCPPORT
from tinytuya.core.crypto_helper import AESCipher
from tinytuya.core.error_helper import ERR_CONNECT, ERR_DEVTYPE, ERR_JSON, ERR_KEY_OR_VER, ERR_OFFLINE, ERR_PAYLOAD, error_json
...
try:
    ...
    from tinytuya.core.XenonDevice import merge_dps_results
    from tinytuya.core.XenonDevice import payload_dict
    CT.payload_dict = payload_dict
